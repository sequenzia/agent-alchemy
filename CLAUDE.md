...
| sdd-tools | create-spec, analyze-spec, create-tasks, execute-tasks, run-tasks | codebase-explorer, researcher, spec-analyzer, task-executor, wave-lead, context-manager, task-executor-v2 | 0.5.1 |
