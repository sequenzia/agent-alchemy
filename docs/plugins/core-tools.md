...
Core Tools (v0.2.2) provides the foundational analysis and exploration capabilities for Agent Alchemy. It contains the **deep-analysis** skill — the keystone of the entire plugin ecosystem — along with supporting skills and agents that power codebase understanding across all plugin groups.
