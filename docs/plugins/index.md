...
|--------|-------|--------|--------|---------|
| [Core Tools](core-tools.md) | Codebase analysis and exploration | 5 | 3 | 0.2.2 |
| [Dev Tools](dev-tools.md) | Feature development, review, docs | 9 | 4 | 0.3.2 |
| [SDD Tools](sdd-tools.md) | Spec-Driven Development pipeline | 4 | 4 | 0.2.5 |
