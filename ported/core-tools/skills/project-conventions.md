...
**What this component does:** Guides the discovery and application of project-specific coding conventions by examining config files, existing code patterns, and similar features.

**Capabilities needed:**
- File reading and searching (to examine config files and code patterns)
- Shell command execution (for running grep/find to discover patterns)

**Adaptation guidance:**
- The shell command examples (grep, find, ls) are illustrative — adapt to whatever search capabilities your harness provides
- This skill is typically loaded as context by explorer and worker agents, not invoked standalone
- The checklist section can serve as a validation step after feature implementation
