...
description: Provides Mermaid diagram syntax, best practices, and styling rules for technical visualizations. Use when creating diagrams, flowcharts, sequence diagrams, class diagrams, state diagrams, ER diagrams, architecture diagrams, C4 diagrams, visualizations, or any visual documentation in markdown.
dependencies: []
---
...
- **Detailed reference sections** for advanced syntax when building complex diagrams
...
|-------------|----------------|----------|-----------|
| Flowchart | `flowchart` | Process flows, decision trees, pipelines | Included below |
...
| C4 | `C4Context` / `C4Container` / etc. | System architecture, containers, components | Included below |

---

## Quick Reference

Minimal copy-paste examples for simple diagrams. For complex use cases, consult the detailed reference sections below or the separate reference files.
...
## Flowcharts — Detailed Reference

The following provides comprehensive flowchart syntax for complex diagrams.
...
**Edge length:** Add extra dashes/dots/equals to make edges longer (`A ---> B` is longer than `A --> B`).
...
## C4 Diagrams — Detailed Reference
...
**Simple diagrams** — The quick reference and inline sections above are sufficient. Use them for:
...
- C4 diagrams of any complexity (full reference included above)

**Complex or unfamiliar diagrams** — Load the separate reference file when:
...
- **references/sequence-diagrams.md** — Message types, activation, control structures, participant styling
- **references/class-diagrams.md** — Visibility modifiers, generics, namespaces, relationship cardinality
- **references/state-diagrams.md** — Composite states, fork/join, concurrent regions, choice nodes
- **references/er-diagrams.md** — Cardinality notation, identifying relationships, complete schema examples

---

## Integration Notes

**What this component does:** Provides comprehensive Mermaid diagram syntax, styling rules, and examples for creating technical visualizations in markdown documentation.

**Capabilities needed:**
- None — this is a passive knowledge reference loaded by other skills and agents

**Adaptation guidance:**
- This skill is a static knowledge base with no tool interactions or orchestration
- Loaded by multiple other components (codebase-analysis, code-synthesizer, code-architect) as diagram guidance
- The critical styling rules (dark text on nodes) should be enforced regardless of platform
- Reference files in `references/` provide additional depth for specific diagram types
