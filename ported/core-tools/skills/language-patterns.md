...
**What this component does:** Provides copy-paste-ready code patterns and best practices for TypeScript, Python, and React development.
...
- Can be loaded as context by any agent that implements features in these languages
- Content is framework-agnostic within each language section
