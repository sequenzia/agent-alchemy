...
- **Review focus**: One of correctness/edge-cases, security/error-handling, or maintainability/code-quality
- **Files to review**: List of file paths that were modified or created
...
When another agent or the parent skill asks a follow-up question:
