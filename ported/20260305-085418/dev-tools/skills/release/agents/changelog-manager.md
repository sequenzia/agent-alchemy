...
- Prompt describing the scope of changes (e.g., "Analyze commits since the last release")
...
4. For more context on specific commits, run:
   ```bash
...
Report your findings and the updated CHANGELOG.md content back to the parent skill.
