...
Use these templates when generating standalone markdown files in Basic Markdown mode. Each template provides a structural skeleton with placeholder fields to fill from codebase analysis findings.
