#!/bin/bash
# Auto-approve file operations targeting deep-analysis session directories.
# Expects action context as JSON on stdin.
...
# harness to fall through to the normal permission prompt, breaking autonomous execution.
